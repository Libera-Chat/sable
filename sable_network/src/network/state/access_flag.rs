...
pub enum ChannelAccessFlag {
    ...
    InviteonlyInviteSelf = 0x0000_0008,
    InviteonlyInviteOther = 0x0000_0010,

    ReceiveOp = 0x0000_0020,
    ReceiveVoice = 0x0000_0040,
    ReceiveOpmod = 0x0000_0080,
...
impl ChannelAccessSet {
    ...
    pub fn dominates(&self, other: &ChannelAccessSet) -> bool {
        ...
        let implied_flags = [
            ...
            (InviteonlyInviteOther, InviteOther),
            (InviteonlyInviteOther, InviteSelf),
            (InviteonlyInviteSelf, InviteSelf),
