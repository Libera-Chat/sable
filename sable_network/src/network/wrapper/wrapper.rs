...
impl<'a, T: ObjectWrapper<'a>, I: Iterator<Item = &'a T::Underlying>>
    WrappedObjectIterator<'a, T, I>
{
...
impl<'a, T: ObjectWrapper<'a>, I: Iterator<Item = &'a T::Underlying>> Iterator
    for WrappedObjectIterator<'a, T, I>
{
    type Item = T;
