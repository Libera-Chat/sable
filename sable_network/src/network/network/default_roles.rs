...
impl Network
{
    ...
    pub(super) fn build_default_role_cache(&self) -> &HashMap<state::ChannelRoleName, state::ChannelRole>
    {
    ...
    pub(super) fn get_default_role_cache(&self) -> &HashMap<state::ChannelRoleName, state::ChannelRole>
    {
