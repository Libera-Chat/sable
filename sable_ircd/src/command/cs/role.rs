...
pub(super) async fn handle_role(source: UserId, cmd: Arc<ClientCommand>) -> CommandResult
{
...
async fn role_list(source: UserId, cmd: Arc<ClientCommand>) -> CommandResult
{
...
async fn role_edit(source: UserId, cmd: Arc<ClientCommand>) -> CommandResult
{
    let net = cmd.server.network();
...
async fn role_add(source: UserId, cmd: Arc<ClientCommand>) -> CommandResult
{
    let net = cmd.server.network();
...
async fn role_delete(source: UserId, cmd: Arc<ClientCommand>) -> CommandResult
{
    let net = cmd.server.network();
