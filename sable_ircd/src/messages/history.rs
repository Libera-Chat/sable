...
{
    fn send_to(&self, conn: &ClientConnection, from_entry: &HistoryLogEntry) -> HandleResult;

    fn send_historic(&self, conn: &ClientConnection, from_entry: &HistoryLogEntry) -> HandleResult
    {
...
{
    fn send_to(&self, conn: &ClientConnection, _from_entry: &HistoryLogEntry) -> HandleResult
    {
        match &self.details
        {
...
{
    fn send_to(&self, _conn: &ClientConnection, _from_entry: &HistoryLogEntry) -> HandleResult
    {
        Ok(())
    }
}
